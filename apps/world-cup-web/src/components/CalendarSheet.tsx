...
function cellClass(cell: DayCell): string {
  ...
  if (cell.isSelected) return `${base} bg-accent-exact text-bg-base font-bold`;
  if (cell.isToday) return `${base} text-accent-exact ring-1 ring-accent-exact/60 hover:bg-bg-elevated`;
  if (cell.isCurrentMonth) return `${base} text-text-primary hover:bg-bg-elevated`;
