    ...
    <div className="mx-auto w-full max-w-5xl px-4 pb-16 sm:px-6">
      <header className="mb-8 text-center">
        <h1 className="bg-gradient-to-r from-teal-600 via-emerald-500 to-cyan-500 bg-clip-text text-4xl font-extrabold text-transparent sm:text-5xl dark:from-teal-400 dark:via-emerald-300 dark:to-cyan-300">
          Train your brain, one loop at a time
        </h1>
        <p className="mx-auto mt-3 max-w-xl text-slate-500 dark:text-slate-400">
          Bite-sized games across memory, attention, speed, problem solving and flexibility. Pick one and go.
        </p>

        {streak > 0 && (
          <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-1.5 text-sm font-bold text-amber-700 shadow-sm ring-1 ring-amber-200 dark:bg-amber-500/15 dark:text-amber-300 dark:ring-amber-500/20">
