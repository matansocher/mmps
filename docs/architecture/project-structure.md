...
mmps/
├── src/                    # Source code
├── apps/                   # npm workspaces — Vite mini-apps (chatbot-web, coach-web, learner-web, savings-web)
...
│
├── features/              # Bot implementations (6 bots + savings web app)
