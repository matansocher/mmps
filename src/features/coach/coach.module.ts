...
@Module({
  ...
  providers: [CoachController, CoachBotSchedulerService, CoachService, CompetitionTableCacheService, MatchesSummaryCacheService, TelegramBotsFactoryProvider(BOTS.COACH)],
