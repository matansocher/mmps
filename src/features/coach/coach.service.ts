...
export class CoachService {
  ...
  async getMatchesPredictionsVerificationMessage(date: string, competitionIds: number[] = []): Promise<string> {
    return await this.predictionsService.generatePredictionsVerification(date, competitionIds);
  }
}
