...
export const MAX_NUM_OF_PERMANENT_SUBSCRIPTIONS_PER_USER = 10;
export const PERMANENT_SUBSCRIPTION_ALERT_INTERVAL_HOURS = 4;
...
export const ANALYTIC_EVENT_NAMES = {
  ...
  CHANGE_PAGE: 'CHANGE_PAGE',
  PERMANENT_SUBSCRIBE: 'PERMANENT_SUBSCRIBE',
  PERMANENT_UNSUBSCRIBE: 'PERMANENT_UNSUBSCRIBE',
  PERMANENT_SUBSCRIPTION_FULFILLED: 'PERMANENT_SUBSCRIPTION_FULFILLED',
  ERROR: 'ERROR',
};
