...
export const youtubeTool = tool(runner, {
  name: 'youtube',
  description:
    'Get the latest YouTube videos of a channel (with title, stats, and duration), channel info, the transcript of a specific video (for summarizing or answering questions about its content), or manage subscriptions for the daily 22:45 social media digest: subscribe/unsubscribe to a channel, or list current subscriptions. Accepts handles (@Fireship), channel URLs, or channel IDs.',
  schema,
});
