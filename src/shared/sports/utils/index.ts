...
export { getSportsCompetitionTable } from './get-sports-competition-table';
export { getSportsCompetitions } from './get-sports-competitions';
export { getSportsMatchesSummary } from './get-sports-matches-summary';
